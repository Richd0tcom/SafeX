...
const Receipt = () => {
  return (
    <div classNameName="px-4 py-2 text-gray-800">
                    <div classNameName="hidden xl:flex flex-row justify-between shadow-md border rounded-md">
                      <div
                      ...
                      <div className="relative flex flex-col w-3/4">
                        ...
                        <div className="absolute self-end mr-1 mt-1">
                          <p
                            className="px-4 py-2 text-xs font-bold text-red-800 bg-white rounded-md "
                          >
                    ...
                    <div className="xl:hidden flex flex-col bg-white border rounded-md shadow-md">
                     ...
                     <div className="py-2 px-4 flex flex-col text-sm md:text-2xl">
                       ...
                       <div className="flex text-sm md:text-xl justify-between my-2">
                         ...
                         <p className="font-bold text-red-800">Banua Coder Coworking Space, Palu, Sulawesi Tengah, Indonesia</p>
                       </div>
                     </div>
                     ...
                     <div className="py-2 px-4 flex flex-col text-sm md:text-2xl">
                       ...
                       className="mx-auto my-2"
                            src="https://ad-venture.org.uk/wp-content/uploads/2017/05/logo-placeholder.png" alt="e"
                          />
                     </div>
                    </div>
                </div>

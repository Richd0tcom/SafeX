          ...
          <div className="flex flex-col w-full md:space-y-4">
            <header className="w-full h-16 z-40 flex items-center justify-between">
              ...
              <div className="relative z-20 flex flex-col justify-end h-full px-3 md:w-full">
                <div className="relative p-1 pt-2 flex items-center w-full space-x-4 justify-end">
                  <button
                    type="button"
                    className="inline-flex items-center justify-center rounded-lg px-4 py-2 mt-2 transition duration-500 ease-in-out text-white bg-blue-500 hover:bg-blue-400 focus:outline-none"
                    onClick={() => {
                      auth.signOut();
                    }}
                  >
            ...
            <div className="overflow-auto h-screen pb-24 px-4 md:px-6">
              ...
              <h2 className="text-md text-gray-400">
                Here&#x27;s what&#x27;s happening with your SafeX account today.
              </h2>
